...
class CataData:
    ...
    def cutout(self, coords: np.ndarray, field: Union[str, int], return_wcs: bool = False) -> Union[tuple, np.ndarray]:
    ...
    def _build_images(self, drop_axes: List[int]) -> Tuple[Dict[Union[str, int], np.ndarray], Dict[Union[str, int], any]]:
